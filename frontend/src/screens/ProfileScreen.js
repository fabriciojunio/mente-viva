...
const styles = StyleSheet.create({
  ...
  achDone:     { backgroundColor:'#292218', borderWidth:2, borderColor:COLORS.amber },
  ...
  privacyCard: { margin:14, marginTop:4, backgroundColor:'#162118', borderRadius:RADIUS.lg, padding:16, borderLeftWidth:4, borderLeftColor:COLORS.mint },
  privacyTitle:{ fontSize:14, fontWeight:'900', color:COLORS.mint, marginBottom:6 },
